...
@spaces_router.get("/spaces", tags=["spaces"], response_model=list[SpaceModel], status_code=status.HTTP_200_OK)
def getSpacesList():
...
@spaces_router.get("/space/{space_id}", tags=["spaces"], response_model=SpaceModel, status_code=status.HTTP_200_OK)
...
@spaces_router.post("/space", tags=["spaces"], status_code=status.HTTP_201_CREATED, response_model=PostModelResponse)
...
@spaces_router.put("/space/{space_id}", tags=["spaces"], status_code=status.HTTP_200_OK, response_model=PutModelResponse)
...
@spaces_router.put("/space/{space_id}/invite/accepted", tags=["spaces"], status_code=status.HTTP_200_OK, response_model=PutModelResponse)
...
@spaces_router.delete("/space/{space_id}", tags=["spaces"], status_code=status.HTTP_200_OK, response_model=DeleteModelResponse)
