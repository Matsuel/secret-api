...
@categories_router.get("/categories", tags=["categories"], response_model=list[CategoryModel], status_code=200)
...
@categories_router.get("/categories/{category_id}", tags=["categories"], response_model=CategoryModel, status_code=200)
...
@categories_router.post("/categories", tags=["categories"], status_code=201, response_model=PostModelResponse)
...
@categories_router.put("/categories/{category_id}", tags=["categories"], response_model=PutModelResponse)
...
@categories_router.delete("/categories/{category_id}", tags=["categories"], response_model=DeleteModelResponse)
